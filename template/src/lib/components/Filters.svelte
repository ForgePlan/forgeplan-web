<script lang="ts">
  import { kindLabel, kindColor, statusRing } from '$lib/theme';

  export let kinds: string[] = [];
  export let statuses: string[] = [];
  export let kindFilter: Set<string>;
  export let statusFilter: Set<string>;
    ...
    <div class="row">
      {#each kinds as k}
        <button
          ...
          on:click={() => (kindFilter = toggle(kindFilter, k))}
        >
    ...
    <div class="row">
      {#each statuses as s}
        <button
          ...
          on:click={() => (statusFilter = toggle(statusFilter, s))}
        >
